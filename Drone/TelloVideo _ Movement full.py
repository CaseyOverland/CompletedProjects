        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_8:
                    tello.command('forward 40')
                elif event.key == pygame.K_2:
                    tello.command('back 40')
                elif event.key == pygame.K_4:
                    tello.command('left 40')
                elif event.key == pygame.K_6:
                    tello.command('right 40')
                elif event.key == pygame.K_7:
                    tello.command('ccw 45')
                elif event.key == pygame.K_9:
                    tello.command('cw 45')
                elif event.key == pygame.K_1:
                    tello.command('up 60')
                elif event.key == pygame.K_3:
                    tello.command('down 60')
                elif event.key == pygame.K_LEFT:
                    tello.command('flip r')
                elif event.key == pygame.K_RIGHT:
                    tello.command('flip l')
                elif event.key == pygame.K_t:
                    tello.command('takeoff')
                elif event.key == pygame.K_5:
                    tello.command('up 120')
                    time.sleep(5)
                    aim = input("How many degrees clockwise till target? ")
                    aim = str("cw " + aim)
                    tello.command(aim)
                    time.sleep(1)
                    tello.command('forward 200')
                    time.sleep(1)
                    tello.command('ccw 270')
                    time.sleep(1)
                    tello.command('forward 200')
                    time.sleep(1)
                    tello.command('ccw 270')
